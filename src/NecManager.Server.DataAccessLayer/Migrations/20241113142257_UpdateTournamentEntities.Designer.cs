...
namespace NecManager.Server.DataAccessLayer.Migrations
{
    ...
    [Migration("20241113142257_UpdateTournamentEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NecManager.Server.DataAccessLayer.Model.MatchResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NecManager.Server.DataAccessLayer.Model.Team", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NecManager.Server.DataAccessLayer.Model.Tournament", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("Rank2Id")
                        .HasColumnType("int");

                    b.Property<int>("Rank3Id")
                        .HasColumnType("int");

                    b.Property<int>("Rank4Id")
                        .HasColumnType("int");

                    b.Property<int>("Rank5Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudentTeam", b =>
                {
                    b.Property<string>("TeamMatesId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("TeamsId")
                        .HasColumnType("int");

                    b.HasKey("TeamMatesId", "TeamsId");
            ...
            modelBuilder.Entity("NecManager.Server.DataAccessLayer.Model.MatchResult", b =>
                {
                    b.HasOne("NecManager.Server.DataAccessLayer.Model.Tournament", null)
                        .WithMany("Matchs")
            ...
            modelBuilder.Entity("StudentTeam", b =>
                {
                    ...
                    b.HasOne("NecManager.Server.DataAccessLayer.Model.Team", null)
                        .WithMany()
